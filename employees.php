          <div class="row">
                                            ...
                                            <div class="col-md-3 no-pad">
                                                <form action="search.html" class="customers-search-form">
                                                    <input type="text" name="search" class="search" placeholder="Search Employees / Users"><a href="" class="employees_open"><div class="add-user"><i class="fa fa-user-plus middle" aria-hidden="true"></i></div></a>
                                                </form>
